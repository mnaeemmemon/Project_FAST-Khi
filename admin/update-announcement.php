...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Update Announcement | Admin Portal</title>
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Update Announcement</h4>
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-12">
										<div class="ml-auto">
											<h3>Change Announcement Details</h3>
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Announcement Name</label>
										<div>
									...
									<div class="form-group col-6">
										<label class="col-form-label">Announcement Date</label>
										<div>
											<input class="form-control" type="date" value="" name="quantity">
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Announcement Image 1 (Image Format Should be JPEG)</label>
										<div>
									...
									<div class="form-group col-6">
										<label class="col-form-label">Announcement Image 2 (Image Format Should be JPEG)</label>
										<div>
									...
									<br>
									<div class="form-group col-6">
										<label class="col-form-label">Announcement Image 3 (Image Format Should be JPEG)</label>
										<div>
